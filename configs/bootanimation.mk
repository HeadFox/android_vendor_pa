...
# PA XHDPI Devices
ifneq ($(filter pa_edison pa_maserasti pa_spyder pa_targa pa_umts_spyder pa_hikari pa_nozomi pa_jewel pa_tate pa_jem pa_jemlte pa_enrc2b pa_evita pa_falcon pa_melius3gxx pa_meliusltexx pa_mint pa_moto_msm8960 pa_moto_msm8960dt pa_d2lte pa_gee pa_geeb pa_hercules pa_i605 pa_i9300 pa_l900 pa_m4 pa_n7000 pa_n7100 pa_p880 pa_skyrocket pa_tf201 pa_togari pa_v500 pa_vanquish,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
        vendor/pa/prebuilt/bootanimation/1280x720.zip:system/media/bootanimation.zip
endif

# PA HDPI Devices
ifneq ($(filter pa_galaxysmtd pa_i9100 pa_i9100g pa_p3100 pa_haida pa_p3110 pa_xt907 pa_serrano3gxx pa_serranoltexx pa_taoshan pa_ville,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
